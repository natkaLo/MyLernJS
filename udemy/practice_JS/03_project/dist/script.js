...
function () {
  ...
  function Slider(page, btns, showElementByTimeClassName) {
    _classCallCheck(this, Slider);

    //page- на какой странице слайдер, btns - кнопки переключения
  ...
  _createClass(Slider, [{
    ...
    value: function showByTime() {
      ...
      setTimeout(function () {
        _this.showElementByTime.style.opacity = '1';

        _this.showElementByTime.classList.add('slideInUp');
      }, 3000);
