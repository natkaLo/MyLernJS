...
/*#__PURE__*/
function () {
  function Difference(officerBlock, itemsClassName) {
    _classCallCheck(this, Difference);

    this.officerBlock = document.querySelector(officerBlock);

    try {
      this.items = this.officerBlock.querySelectorAll(itemsClassName);
    } catch (e) {}
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers() {
      ...
      try {
        this.officerBlock.querySelector('.plus').addEventListener('click', function () {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function clearInputs() {
      this.imputs.forEach(function (item) {
        item.value = "";
      });
    }
  }, {
    ...
    value: function initMask() {
      ...
      var inputs = document.querySelectorAll('[name="phone"]'); //получим все инпуты для номеров телефонов
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggers, overlayWindow) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindCloseBtn() {
      ...
      this.closeBtn.addEventListener('click', function (e) {
        _this2.overlayWindow.style.display = 'none';
...
var MainSlider =
/*#__PURE__*/
function (_SliderBase) {
  _inherits(MainSlider, _SliderBase);

  function MainSlider(obj, showElementByTimeClassName) {
    var _this;

    _classCallCheck(this, MainSlider);

    //получаем в конструктор объект с полями btns, page и значениями .next .page и параметр showElementByTimeClassName со значением.hanson
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, obj)); //родительскому классу Slider отправляем объект
    // console.log(obj);
    //console.log(showElementByTimeClassName);

    _this.showElementByTimeClassName = showElementByTimeClassName; //класс елемента, который нужно показать через 3 сек
  ...
  _createClass(MainSlider, [{
    key: "showByTime",
    value: function showByTime() {
      var _this2 = this;

      this.showElementByTime.classList.add('animated');
      setTimeout(function () {
        _this2.showElementByTime.style.opacity = '1';

        _this2.showElementByTime.classList.add('slideInUp');
      }, 3000);
    ...
    value: function showSlides(n) {
      ...
      if (n < 1) {
        this.slideIndex = this.slides.length; //console.log(this.slideIndex);
      }
    ...
    value: function bindActions() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          //при клике на логотип - переход к первому слайду
          _this3.slideIndex = 1;
          console.log('ccc');
...
function (_Slider) {
  ...
  function MiniSlider(obj) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, obj));
  }

  _createClass(MiniSlider, [{
    key: "animate",
    value: function animate(activeElem) {
      var _this = this;
      ...
      this.slides.forEach(function (slide) {
        _this.animateElements.forEach(function (elem) {
    ...
    key: "decorizesSlides",
    value: function decorizesSlides() {
      var _this2 = this;
    ...
    value: function bindTriggers() {
      ...
      this.next.forEach(function (item) {
        ...
        item.addEventListener('mouseenter', function () {
          return _this4.stopAnimation();
        });
        item.addEventListener('mouseleave', function () {
          return _this4.activateAnimation();
        });
...
function () {
  _createClass(SliderBase, [{
    ...
    value: function getSlidesArr() {
      ...
      try {
        ...
        var array = Array.from(this.container.children); //console.log(this.container.children);

        this.slides = array.filter(function (child) {
  ...
  function SliderBase() {
    ...
    var btns = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
function (_SliderBase) {
  ...
  function Slider() {
    ...
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        _ref$animateElements = _ref.animateElements,
        animateElements = _ref$animateElements === void 0 ? null : _ref$animateElements,
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Slider).call(this, container, btns, prev, next));
  ...
  _createClass(Slider, [{
    key: "updateSlidersArr",
    value: function updateSlidersArr() {
  ...
  return Slider;
}(SliderBase); //создание слайдера без наследования (только слайдер с первой страницы)
