...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      console.log(api); // //отправляем данные на сервер (нужно знать, в каком формате сервер принимает данные. Если в фор-те JSon - надо перевести данные в JSON)
...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  ...
  btn.addEventListener('click', function () {
    cards.forEach(function (card) {
      ...
      card.classList.add('col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1'); //кнопка должна исчезнуть со страницы
