...
var forms = function forms() {
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.status').textContent = message.loading; //т.к  отправим в формате FormData, заголовок устанавливать не нужно
  ...
  var clearImputs = function clearImputs() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      var formData = new FormData(item); //отправляем данные на сервер (нужно знать, в каком формате сервер принимает данные. Если в фор-те JSon - надо перевести данные в JSON)
      ...
      .then(function (res) {
        ...
        clearImputs(); //удалим оповещение пользователя
...
var modals = function modals() {
  ...
  //closeSelector - селектор по которому будем закрывать окно
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent(); //клик на табе. Навешиваем обработчик на элемент содержащий в себе все табы

  header.addEventListener('click', function (e) {
    var target = e.target; //проверяем, что кликнули на табе. По нему самому или по элементу внутри него (дочернему для которого таб будет parentNode)
