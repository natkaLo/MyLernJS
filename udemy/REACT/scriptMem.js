...
//установить
//npm i json-server  в папку проекта
//npm install -g json-server- глобально (запускать его сможем из любой папки)
// запуск
//заходим в папку проекта в терминале. Пишем json-server и путь к файлу json
//npx json-server --watch src/db.json
//он запуститься по умолчанию на 3000 порту. Поэтому, надо сначала остановить реакт проэкт, запустить json сервер а потом запустить реакт
//либо указать серверу порт
...
//загетанные файлы нужно сделать из них реакт проэкт
//заходим в папку с загетанным проэтом и пишем командs
//npm i create-react-app  
//npm i create-react-app -g - глобально

//создание нового реакт проэкта
...
//---------------------------------------------------------------
//добавление слилей bootstrap при помощи cdn
